    ...
    methods: {
        ...
        formTell: function () {
            if (this.userInfo.tell.length > 3 && this.userInfo.tell.length < 9) {
                ...
                this.userInfo.tell =
                    this.userInfo.tell.substring(0, 3) + '-' + this.userInfo.tell.substring(3, 7);
            ...
            } else if (this.userInfo.tell.length > 9 && this.userInfo.tell.length < 14) {
                this.userInfo.tell = this.userInfo.tell.replaceAll('-', '');
                this.userInfo.tell =
        ...
        changeColor: function (no, that, id) {
            let pass =
                document.getElementById('password').parentNode.parentNode.parentNode.parentNode;
            let checkPass =
                document.getElementById('checkPassword').parentNode.parentNode.parentNode
                    .parentNode;
            ...
            if (no == 2) {
                if (that != 'FAIL') {
                    ...
                    pass.className = 'el-form-item asterisk-left el-form-item--feedback is-error';
                    checkPass.className =
