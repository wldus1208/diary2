    ...
    <div class="content">
        ...
        <div id="divNotice">
            <p class="conTitle">
                <span>에디터</span>
                <span>
                    참고 사이트 :: https://element-plus.org/en-US/ <br /><br />-- npm install
                    <br />npm install element-plus --save <br />npm i unplugin-auto-import
                    unplugin-vue-components -D <br />npm install @element-plus/icons-vue
                    <br /><br />-- main.js <br />import ElementPlus from "element-plus";<br />
                    import "element-plus/dist/index.css"; <br />import * as ElementPlusIconsVue from
                    '@element-plus/icons-vue'; <br /><br />for (const [key, component] of
                    Object.entries(ElementPlusIconsVue)) { app.component(key, component) }
                    <br /><br />app .use(store) <br />.use(router) <br />.use(VueSession,
                    sessionOptions) <br />.use(Paginate) <br />//.use(twLib)
                    <br />.use(VueDaumpostcode) <br />.use(ElementPlus) <br />.mount("#app");
                </span>
            </p>
        </div>
